...
var init_app = __esm({
  ...
  <div class="center-logo">
    <a routerLink="/" class="logo-link">
      <img 
      src="assets/fritid_logo2.jpeg" 
      alt="Fritid Shop Logo"
      class="logo"
      >
    </a>
  </div>
  <nav>
    ...
    <a [routerLink]="['/cart']">Ko\u0161arica ({{ cartItemCount }})</a>
    
    <!-- Authentication section -->
    <ng-container *ngIf="user$ | async as user; else authButtons">
      <div class="user-section">
        <span class="user-greeting">Pozdravljeni, {{ user.name }}!</span>
    ...
    <ng-template #authButtons>
      <a [routerLink]="['/auth']" class="auth-link">
  ...
  "src/app/service/cart.service.ts"() {
    ...
    CartService = class CartService2 {
      ...
      addItemToCart(product, quantity, selectedColor) {
        ...
        const existingItem = currentItems.find((item) => item.product.id === product.id && item.selectedColor === selectedColor);
        if (existingItem) {
...
var init_footer_component = __esm({
  ...
  <div class="footer-container">
    ...
    <div class="footer-section">
      <h3 class="footer-title">Kontaktni podatki</h3>
    ...
    <!-- General Information -->
    <div class="footer-section">
      <h3 class="footer-title">Splo\u0161ne informacije</h3>
      <ul class="footer-links">
        @for (item of generalInfo; track item) {
          <li>
            <a [routerLink]="[item.link]" class="footer-link">{{ item.label }}</a>
          </li>
        }
      </ul>
    </div>
    ...
    <!-- General Terms -->
    <div class="footer-section">
      <h3 class="footer-title">Splo\u0161ni pogoji</h3>
      <ul class="footer-links">
        @for (item of generalTerms; track item) {
          <li>
            <a [routerLink]="[item.link]" class="footer-link">{{ item.label }}</a>
            <!-- <p>TODO link</p> -->
          </li>
    ...
    <!-- My Data -->
    <div class="footer-section">
      <h3 class="footer-title">Moji podatki</h3>
      <ul class="footer-links">
        @for (item of myData; track item){
          <li>
            <a [routerLink]="['item.link']" class="footer-link">{{ item.label }}</a>
             <!-- <p>TODO link</p> -->
          </li>
...
// angular:jit:style:src/app/components/footer/footer.component.scss
...
// src/app/service/info.service.ts
var InfoService;
var init_info_service = __esm({
  "src/app/service/info.service.ts"() {
    "use strict";
    init_tslib_es6();
    init_core();
    InfoService = class InfoService2 {
      infoPages = [
        {
          id: 1,
          label: "O nas",
          link: "/info/1",
          content: `Podjetje FRITID d.o.o.  je slovensko podjetje, v katerem vam lahko po konkuren\u010Dnih cenah ponudimo stekleno embala\u017Eo kot tudi plasti\u010Dno embala\u017Eo razli\u010Dnih volumnov.
...
`
        ...
        {
          id: 4,
          label: "Reklamacije in vra\u010Dilo blaga",
          link: "/info/4",
          content: `
Vra\u010Dila blaga
...
Morebitni spori med strankami, ki izvirajo ali so v kakr\u0161nikoli povezavi z elektronsko trgovino se re\u0161ujejo sporazumno, v nasprotnem primeru se stranke dogovorijo, da bo spor re\u0161evalo pristojno sodi\u0161\u010De v Kamniku ob uporabi slovenskega prava.`
        ...
        {
          id: 6,
          label: "Cene in pla\u010Dilni pogoji",
          link: "/info/6",
          content: `Izdelke je potrebno pla\u010Dati v enkratnem znesku, razen, kjer je druga\u010De to izrecno navedeno.
