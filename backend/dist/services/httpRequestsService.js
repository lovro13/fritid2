...
exports.apiRequestToMinimax = apiRequestToMinimax;
...
async function getToken({ username, password }) {
    logger_1.default.info("getToken called");
...
async function apiRequestToMinimax({ method = 'GET', path, token, query = {}, body = null }) {
    ...
    if (res.status < 200 || res.status >= 300) {
        ...
        logger_1.default.info(`Minimax API ${method} ${path} failed with status ${res.status}:`, res.data);
        error.response = res;
        throw error;
    }
...
exports.default = { httpsRequest, getToken, apiRequestToMinimax };
